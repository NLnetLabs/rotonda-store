...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let pfxs = vec![
        ...
        Prefix::new_relaxed(0b1111_1111_1111_1111_1111_1111_1111_1111_u32.into_ipaddr(), 32),
        ...
        Prefix::new_relaxed(0b1011_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 4),
        ...
        Prefix::new_relaxed(0b1111_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 4),
        Prefix::new_relaxed(0b1111_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 9),
        Prefix::new_relaxed(0b1111_0000_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 9),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 12),
        Prefix::new_relaxed(0b1111_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 9),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 9),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 10),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 11),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 12),
        Prefix::new_relaxed(0b0111_0111_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 12),
        Prefix::new_relaxed(0b0111_0111_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 13),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 13),
        Prefix::new_relaxed(0b0111_0111_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 14),
        Prefix::new_relaxed(0b0111_0111_0100_0000_0000_0000_0000_0000_u32.into_ipaddr(), 14),
        Prefix::new_relaxed(0b0111_0111_1000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 14),
        Prefix::new_relaxed(0b0111_0111_1100_0000_0000_0000_0000_0000_u32.into_ipaddr(), 14),
        Prefix::new_relaxed(0b1110_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 4),
        ...
        Prefix::new_relaxed(0b0011_0000_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 4),
        Prefix::new_relaxed(0b1000_0011_1000_1111_0000_0000_0000_0000_u32.into_ipaddr(), 11),
        Prefix::new_relaxed(0b1000_0010_0101_0111_1111_1000_0000_0000_u32.into_ipaddr(), 13),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 24),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 25),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 128).into(), 25),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 26),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 64).into(), 26),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 128).into(), 26),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 192).into(), 26),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 3).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 4).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 5).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 16).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 12).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 63).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 127).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 128).into(), 32),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 129).into(), 32),
        Prefix::new_relaxed(0b1111_1111_0000_0001_0000_0000_0000_0000_u32.into_ipaddr(), 12),
        Prefix::new_relaxed(0b1111_1111_0011_0111_0000_0000_0000_0000_u32.into_ipaddr(), 17),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(100, 0, 12, 0).into(), 24),
        Prefix::new_relaxed(0b0000_0001_0000_0000_0000_0000_0000_0000_u32.into_ipaddr(), 24),
    ...
    for spfx in &[
        ...
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 24),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 23),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 25),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 0).into(), 26),
        Prefix::new_relaxed(std::net::Ipv4Addr::new(130, 55, 240, 192).into(), 26),
        ...
        let s_spfx = tree_bitmap.match_prefix(&spfx.unwrap(), &MatchOptions {
